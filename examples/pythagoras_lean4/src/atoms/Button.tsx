...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-sky-500 hover:bg-sky-400 text-slate-950 font-semibold focus:ring-sky-400 shadow-sm',
    secondary: 'bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 focus:ring-slate-500',
    ghost: 'bg-transparent hover:bg-slate-800/60 text-slate-300 focus:ring-slate-600',
    danger: 'bg-rose-500 hover:bg-rose-400 text-white focus:ring-rose-400'
  };
