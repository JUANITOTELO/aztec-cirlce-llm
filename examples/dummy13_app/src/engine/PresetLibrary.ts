...
export const POSE_PRESETS: PoseData[] = [
  {
    ...
    timestamp: Date.now(),
    joints: {
      pelvis: { rotation: new THREE.Quaternion(0, 0, 0, 1), position: { x: 0, y: 1.1, z: 0 } },
      spine_lower: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      spine_upper: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      neck: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      head: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      ...
      elbow_l: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      elbow_r: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      hip_l: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      hip_r: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      knee_l: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      knee_r: { rotation: new THREE.Quaternion(0, 0, 0, 1) }
    }
  },
  {
    id: 'hero_landing',
    ...
    timestamp: Date.now(),
    joints: {
      pelvis: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.45, 0.05, 0)), position: { x: 0, y: 0.45, z: 0 } },
      spine_lower: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.35, 0, 0)) },
      spine_upper: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.3, 0, 0)) },
      neck: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.4, 0, 0)) },
      head: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.3, 0, 0)) },
  ...
  },
  {
    ...
    timestamp: Date.now(),
    joints: {
      pelvis: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0, 0.35, 0)), position: { x: 0, y: 0.9, z: 0 } },
      spine_lower: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.05, -0.15, 0)) },
      spine_upper: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.05, -0.1, 0)) },
      neck: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -0.1, 0)) },
      head: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0, -0.1, 0)) },
      ...
      shoulder_r: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.3, -0.4, -1.1)) },
      elbow_r: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(1.8, 0, 0)) },
      hip_l: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.8, 0.3, 0.2)) },
      knee_l: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-1.3, 0, 0)) },
      hip_r: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.4, -0.2, -0.4)) },
  ...
  },
  {
    ...
    timestamp: Date.now(),
    joints: {
      pelvis: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.35, 0, 0)), position: { x: 0, y: 0.98, z: 0 } },
      spine_lower: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.15, -0.1, 0)) },
      spine_upper: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.1, 0.1, 0)) },
      neck: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.2, 0, 0)) },
      head: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.15, 0, 0)) },
  ...
  },
  {
    ...
    timestamp: Date.now(),
    joints: {
      pelvis: { rotation: new THREE.Quaternion(0, 0, 0, 1), position: { x: 0, y: 0.28, z: 0 } },
      spine_lower: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.05, 0, 0)) },
      spine_upper: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.05, 0, 0)) },
      neck: { rotation: new THREE.Quaternion(0, 0, 0, 1) },
      head: { rotation: new THREE.Quaternion().setFromEuler(new THREE.Euler(0.08, 0, 0)) },
